...
const WEATHER_API_KEY = 'ab4e6e263a684276949195241200505';

function getIsland(islandId) {
  console.log(islandId, islandData[islandId]);
  return fetch(
    `https://api.weatherapi.com/v1/current.json?key=ab4e6e263a684276949195241200505&q=${islandData[islandId].handle}`
  )
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
